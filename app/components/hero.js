    ...
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative flex flex-col items-center justify-center w-full h-full text-center px-4 md:px-8">
        <div
          ...
          className="mb-4 opacity-0 relative w-[140px] h-[140px]"
        >
          <Image
        ...
        <motion.h1
          ref={scope}
          className="max-w-4xl text-white text-3xl md:text-5xl font-bold leading-tight uppercase drop-shadow-2xl font-cp-bold tracking-widest"
        >
          {"SENTIRTE BIEN EMPIEZA CON VERTE BIEN"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        <p
          ...
          data-aos-delay="200"
          data-aos-duration="1000"
          className="text-white text-sm md:text-md max-w-xl mt-5 text-shadow-custom font-futura-medium leading-snug opacity-0"
        >
          En Abraham Studio encontrarás un espacio donde la excelencia en cortes
          y cuidado de barba se combina con una experiencia única. Forma parte
          de una comunidad que entiende que verse bien es solo el comienzo.
        </p>
      ...
      <ScrollParallax isAbsolutelyPositioned>
        <div
          ...
          data-aos-delay="800"
          data-aos-duration="1000"
          className="z-50 absolute bottom-5 right-3 md:bottom-10 md:right-16 flex flex-row bg-[#3C5954] gap-3 p-3 rounded-xl opacity-0"
        >
          <Link
